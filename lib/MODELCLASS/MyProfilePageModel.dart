...
MyProfileDetails myProfileDetailsFromJson(String str) => MyProfileDetails.fromJson(json.decode(str));

String myProfileDetailsToJson(MyProfileDetails data) => json.encode(data.toJson());
